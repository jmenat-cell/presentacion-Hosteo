# Hosteo — datos maestros de la empresa

Fuente única de verdad sobre Hosteo. Los materiales comerciales solo pueden afirmar lo que está aquí. Nada `[POR COMPLETAR]` puede aparecer en un entregable. Fuentes: contrato real (`contenido/legal/contrato-modelo.md`), web hosteo.pe (`contenido/copy-web.md`) y datos.json de la web (17 Jul 2026).
...
- **Año de inicio de operaciones**: [POR COMPLETAR]
- **Equipo**: [POR COMPLETAR — quiénes, roles, foto si se usará en materiales]

## Prueba social (pública — utilizable desde Nivel 1; fuente: hosteo.pe)
...
## Contacto (aparece en todos los materiales)

- **WhatsApp / teléfono**: +51 903 191 706 (wa.me/51903191706)
- **Correo público**: hola@hosteo.pe · **Correo operativo/contratos**: propiedades@hosteo.pe
- **Web**: hosteo.pe · **Reservas directas**: booking.hosteo.pe
- **Instagram**: instagram.com/hosteo.pe · **Perfil Airbnb**: airbnb.com.pe/p/hosteo
- **Portal de propietarios**: dashboard.hostaway.com
- **Nombre de quien firma cartas**: [POR COMPLETAR]

## Testimonios (utilizables desde Nivel 2)

> [POR COMPLETAR — cita textual, nombre del propietario, edificio/distrito, con su autorización]
