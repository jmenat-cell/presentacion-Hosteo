...
4. **Genera**: copia `plantillas/documento.html` a `prospectos/<slug>/entregables/AAAA-MM-DD-carta-n<N>.html` y redacta: saludo personal, apertura que referencia el contacto previo, mensaje central en el destacado, 3 beneficios máximo, cierre con UN llamado a la acción fácil. Máximo ~300 palabras; una carta que no se lee no vende. Sin `⟦corchetes⟧` remanentes. Debe caber en una página (verifícalo en el PDF).
