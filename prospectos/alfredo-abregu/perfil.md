# Perfil de prospecto — Alfredo Abregu

- **Nombre**: Alfredo Abregu
- **Slug**: `alfredo-abregu`
- **Contacto**: +51 978 158 400 (WhatsApp)
...
| Edificio / dirección | Distrito | Tipología | m² | Amoblado | Notas |
|---|---|---|---|---|---|
| Proyecto Urban Heights (Edifica), Paseo de la República al lado de Tottus Express | Miraflores | 1 dormitorio | 41 | Por implementar (estreno) | Separado el 15 Jul 2026; entrega aprox. octubre 2026 |

## Parámetros de proyección (dados por Javier, 17 Jul 2026)

- Tarifa estimada por noche: US$ 40 ("debería rondar los $40" → proyección en rango US$ 35–40)
- Ocupación esperada: 85% (igual al promedio del portafolio)

## Historial y notas

- 2026-07-09: primer contacto por WhatsApp; pidió opinión de rentabilidad ANTES de comprar (evaluaba Barranco/TyC Aspitia, 1 hab en Enrique Barrón, luego Surquillo/Element). Dijo desde el inicio: "es para alquilar con Airbnb y me gustaría que ustedes se encarguen". Desconfía de proyecciones de terceros (asesora TyC le prometió ~US$ 180/noche).
